...
# ///////////////////////////////////////////////////////////////
from UI.widgets.py_table_widget.py_table_widget import PyTableWidget
...
from PyQt5.QtWidgets import QHBoxLayout,QVBoxLayout,QLabel,QStackedWidget,QWidget,QFrame,QScrollArea
from PyQt5.QtCore import QSize,Qt,QCoreApplication,QMetaObject,QRect
from PyQt5.QtGui import QIcon
from PyQt5.QtSvg import QSvgWidget
from UI.widgets import PyGrips,PyPushButton
...
class SetupMainWindow:
    ...
    add_left_menus = [
        ...
        },
        {
            ...
            "btn_id" : "btn_function",
            "btn_text" : "Function",
            "btn_tooltip" : "Perform some functions",
            "show_top" : True,
            "is_active" : False
        },
        {
    ...
    def setup_gui(self):
        ...
        # Base map page
        # BTN 5-8
        btn_ui=[self.ui.left_column.menus.btn_5_layout,
                 self.ui.left_column.menus.btn_6_layout,
                 self.ui.left_column.menus.btn_7_layout,
                 self.ui.left_column.menus.btn_8_layout]
        btnlist=['style5','style6','style7','style8']
        for btnid in range(4):
            btn=PyPushButton(
                text="Btn 1",
                radius=8,
                color=self.themes["app_color"]["text_foreground"],
                ...
                bg_color_hover=self.themes["app_color"]["dark_three"],
                bg_color_pressed=self.themes["app_color"]["dark_four"],
                obj_name=btnlist[btnid]
            )
            btn.setMaximumHeight(40)
            btn_ui[btnid].addWidget(btn)
