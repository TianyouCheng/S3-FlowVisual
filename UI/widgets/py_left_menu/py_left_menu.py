...
from PyQt5.QtCore import QPropertyAnimation,QEasingCurve,Qt,Signal
...
class PyLeftMenu(QWidget):
    ...
    def btn_clicked(self):
        self.ActiveObject=self.sender().objectName()
    ...
    def toggle_animation(self):
        ...
        self.animation.stop()
        if self._parent.width() == ParentMinWidth:
            self.animation.setStartValue(self._parent.width())
            ...
            self.animation.setStartValue(self._parent.width())
            self.animation.setEndValue(ParentMinWidth)
